...
<script src="https://cdn.jsdelivr.net/gh/virtualvinodh/aksharamukha-web-plugin@v5.0.1/aksharamukha-v5.js"></script>
```

That `@v5.0.1` matters - see "Releasing a new version" below for why real
...
<script src="https://cdn.jsdelivr.net/gh/virtualvinodh/aksharamukha-web-plugin@v5.0.1/aksharamukha-v5.js?engine=api"></script>
...
<script src="https://cdn.jsdelivr.net/gh/virtualvinodh/aksharamukha-web-plugin@v5.0.1/aksharamukha-v5.js?class=verse"></script>
```
...
6. Leave old tags (`@v5.0.1`, etc.) in place, forever - anyone who pinned
